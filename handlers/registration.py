...
class RegistrationForm(forms.Form):
    ...
    source = fields.StringField("Откуда Вы узнали о нашем исследовании?")
...
async def on_form_finished():
    ...
    source = form_data.get("RegistrationForm:source")
    ...
    await db.add_user(tg_id=tg_id, tg_name=tg_name, name=name, age=age, gender=gender, workplace=workplace, workload=workload, subjects=subjects, teaching_experience=teaching_experience, class_management=class_management, classes=classes, source=source, consent_study=consent_study, consent_personal_data=consent_personal_data)
