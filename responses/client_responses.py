...
Нас интересует распределение времени на те или иные виды деятельности в течение рабочего дня, а также работа в нерабочее время. По всем вопросам пишите @annavaskevich
    """,
    "need_registration": "Спасибо, что согласились поучаствовать в исследовании! Для начала ответьте, пожалуйста, на несколько вопросов!",
    "help": """
...
/reminders - включить или выключить напоминания заполнить дневник
    """,
    "ask": "Что Вы сейчас делаете?",
    "message_saved": "Сообщение сохранено 👍",
    "reminders_true": "Теперь бот будет напоминать Вам заполнить дневник. Чтобы выключить напоминания, введите команду /reminders ещё раз.",
    "reminders_false": "Бот больше не будет напоминать Вам заполнить дневник. Чтобы включить напоминания, введите команду /reminders ещё раз."
}
